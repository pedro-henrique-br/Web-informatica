...
export const Location = () => {
  return (
    <Box about="Location" sx={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "15px" }}>
      <Typography style={{fontFamily: "Montserrat", color: "#EEEEEE", fontSize: "2rem", fontWeight: "800" }}>
        Onde estamos?
      </Typography>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center",  gap: "15px" }}>
        ...
        <Box sx={{display: "flex", alignItems: "center", justifyContent: "center", gap: "5px"}}>
          <Typography style={{ textAlign: "center", fontFamily: "Montserrat", color: "#EEEEEE", fontSize: "1.2rem", fontWeight: "600" }}><TiLocation size={26} color={"#F50000"} />  Rua Padre João Francisco de Siqueira Andrade<br></br>n° 41 - Jacareí/São Paulo</Typography>
        </Box>
      </Box>
    </Box>
  );
